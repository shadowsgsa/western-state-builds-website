    ...
    <footer className="bg-construction-darkgray text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="animate-fade-in" style={{ animationDelay: '0.6s' }}>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center">
                <Globe className="h-5 w-5 mr-3 text-construction-brick" />
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center">
          <p className="text-gray-400">&copy; {new Date().getFullYear()} <a href="https://sausinternationalinc.com/">Saus International Inc.com</a> All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
