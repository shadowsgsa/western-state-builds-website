        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden initially-hidden opacity-0 " style={{ animationDelay: '0.2s' }}>
              <img className="h-screen object-cover" src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80" alt="COO" className="w-full h-64 object-cover object-center" />
