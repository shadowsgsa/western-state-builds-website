...
const heroBackground = "/093485ba-917c-4c11-940a-e82b453834fc (1).png";
      ...
      <section className="relative h-screen flex items-center" style={{ backgroundColor: '#000' }}>
       <div 
        ...
        style={{ 
          ...
          backgroundSize: 'cover', // Changed back to 'cover' to fill container
          backgroundPosition: 'center',
          backgroundColor: '#f5f5f5', // Fallback color
          width: '100%',
          height: '100%',
          objectFit: 'cover' // Ensures proper filling
        }}
      ></div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="initially-hidden opacity-0">
              ...
              <p className="text-gray-600 mb-6">
                For over 52 years, Western State Construction has been a leader in the construction industry, 
